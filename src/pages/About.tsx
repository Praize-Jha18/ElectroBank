        ...
        <>
            <div className="relative df-ac">
                ...
                <div className="absolute pl-20 max-tab:pl-10 pr-4 df-fldc-jc max-mdPhone:pl-6 bg-neutral-800 bg-opacity-70 h-full w-full">
                    ...
                    <p className="text-green-50 text-base font-helveticae">EliteCity Savings International  has a legacy spanning more than 100 years</p>
                </div>
            </div>
            {/*about-us  */}
            <div className="details py-14 gap-8 df-fldc-ac px-[15%] max-mdLap:px-[6%] text-center">
                ...
                <p className="font-helvetica text-lg px-28 leading-loose text-[#7a7a7a]">We are proud to be part of the World’s largest banking group by assets, EliteCity Savings International.  Our operations in Jersey, London, the Isle of Man and Mauritius connect people and businesses to international markets.</p>
            ...
            <div className="df-fldc-ac py-20 bg-blue-200 px-[4%] text-center">
                <p className="font-semibold text-xl">Want to Learn More About EliteCity Savings?
                </p>
