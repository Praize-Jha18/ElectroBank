...
Designed to provide financing for the purchase of fixed assets, which usually means real estate, buildings, and machinery`},
                {heading:"Commercial Real Estate",body:"Commercial real estate (CRE) is income-producing real estate that is used solely for business purposes, such as retail centers, office complexes, hotels, and apartments. EliteCity Savings® can provide financing for the acquisition, development, and construction of these properties. This is typically accomplished through commercial real estate loans, which are term loans secured by commercial property rather than residential property. Depending on the property type, there are varying options for down payment, amortization, rate, and loan term."},
