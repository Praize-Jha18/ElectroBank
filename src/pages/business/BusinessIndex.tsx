...
const BusinessIndex = () => {
  ...
  return (
    <>
      ...
      <ShortNote to="" link="INTERNET BANKING" body="You have big goals for your business. Pair your efforts with effective financial solutions and watch ideas take shape." />
