...
const PersonalChecking = () => {
  const detailsData: ReUsableDetailsType = {
    top: "Whether you are looking to switch banks or start a new checking account, EliteCity Savings® offers a variety of accounts to fit your financial needs. As a local community bank, we reinvest your deposits into the communities we serve. When you choose EliteCity Savings, you get a great account with great service, and help the community flourish.",
