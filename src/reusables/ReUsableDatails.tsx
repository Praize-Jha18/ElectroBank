                ...
                <div className=" df-fldc-ac gap-4 mb-6">
                    {props.detailsData.mid.map((value, key) => (
                        <div key={key}>
                            ...
                            <p className="text-lg font-medium text-center pb-8  font-numans  leading-relaxed   text-stone-500 max-mdLap:text-lg max-mdLap:leading-[1.6] max-tab:text-base max-mdPhone:text-sm">{value.body}</p>
                        </div>
                    ))}
                </div>
